...
//IMAGES
import interior from '../images/audi/interior.jpg'
import engine from "../images/audi/engine.jpg"
import back from "../images/audi/rs6-2.jpg"
...
const Audi =()=>{
    ...
    const text = {
        header: (<h1 id="title">AUDI <span><span className="rLogo">R</span>S6</span></h1>),
